...
INSTALLED_APPS = [
    ...
    'menu', #nosso app
    #'widget_tweaks', #Adicionaremos depois para facilitar a estilização de formulários
]
...
# cardapio_config/settings.py
# ...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / 'static', # Para arquivos estáticos globais do projeto (se houver)
...
# ... (no final do arquivo)
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'mediafiles' # BASE_DIR já deve estar definido no topo do settings.py